...
export async function edit3DCode(
  ...
  try {
    ...
    // We can still edit even if there's no code (e.g. GLTF), we just treat it as a new prompt to Claude
    // but the backend might need some code. Let's provide a skeleton if it's empty.
    const codeToPass = threeJsCode.length > 10 ? threeJsCode : '// New Three.js scene based on the provided drawing';
